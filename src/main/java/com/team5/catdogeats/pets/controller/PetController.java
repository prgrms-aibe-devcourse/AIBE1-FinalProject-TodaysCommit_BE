...
public class PetController {
    ...
    public ResponseEntity<ApiResponse<Void>> registerPet(@RequestBody @Valid @Parameter(description = "등록할 펫 정보", required = true) PetCreateRequestDto dto) {
        ...
        return ResponseEntity.created(URI.create("/v1/buyers/pet/" + petId)).body(ApiResponse.success("펫 등록에 성공했습니다.", null));
    }
    ...
    public ResponseEntity<ApiResponse<List<PetResponseDto>>> getMyPets() {
        ...
        return ResponseEntity.ok(ApiResponse.success("펫 목록 조회에 성공했습니다.", pets));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> updatePet(@RequestBody @Valid @Parameter(description = "수정할 펫 정보", required = true) PetUpdateRequestDto dto) {
        ...
        return ResponseEntity.ok(ApiResponse.success("펫 정보 수정에 성공했습니다.", null));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> deletePet(@RequestBody @Valid @Parameter(description = "삭제할 펫 id", required = true) PetDeleteRequestDto dto) {
        ...
        return ResponseEntity.ok(ApiResponse.success("펫 삭제에 성공했습니다.", null));
    }
}
