...
class SellersRepositoryTest {
    ...
    class BasicJpaRepositoryTests {
        ...
        void findById_Success() {
            // when
            Optional<Sellers> result = sellersRepository.findById(String.valueOf(UUID.fromString(testUser1.getId())));
        ...
        void existsById_Test() {
            // when & then
            assertThat(sellersRepository.existsById(String.valueOf(UUID.fromString(testUser1.getId())))).isTrue();
            assertThat(sellersRepository.existsById(String.valueOf(UUID.fromString(testUser2.getId())))).isTrue();
            assertThat(sellersRepository.existsById(String.valueOf(UUID.randomUUID()))).isFalse();
        }
        ...
        void deleteById_Success() {
            ...
            assertThat(sellersRepository.existsById(String.valueOf(UUID.fromString(userIdToDelete)))).isTrue();

            // when
            sellersRepository.deleteById(String.valueOf(UUID.fromString(userIdToDelete)));

            // then
            assertThat(sellersRepository.existsById(String.valueOf(UUID.fromString(userIdToDelete)))).isFalse();
