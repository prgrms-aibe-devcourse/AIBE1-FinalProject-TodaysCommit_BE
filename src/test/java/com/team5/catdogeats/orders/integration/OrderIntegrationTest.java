...
class OrderIntegrationTest {
    ...
    void setUp() {
        ...
        // 인증 정보 설정 (UserPrincipal 2개 파라미터로 수정)
        ...
        validRequest = OrderCreateRequest.builder()
                ...
                .shippingAddress(OrderCreateRequest.ShippingAddressRequest.builder()
                        ...
                        .recipientPhone("010-1234-5678") // recipientPhone 필드 사용
                        .postalCode("12345") // 우편번호
                        .streetAddress("서울특별시 강남구 테헤란로 123") // 기본 주소
                        .detailAddress("456호") // 상세 주소
                        .deliveryNote("문 앞에 놓아주세요") // 배송 요청사항
                        .build())
                .paymentInfo(OrderCreateRequest.PaymentInfoRequest.builder()
                        .orderName("반려동물 용품 주문") // 주문명
    ...
    void createOrder_Success() throws Exception {
        ...
        MvcResult result = mockMvc.perform(post("/v1/buyers/orders")
                ...
                .andExpect(jsonPath("$.data.totalPrice").value(50000)) // totalPrice 필드 사용
                .andReturn();
    ...
    void verifyTestUserInDatabase() {
        ...
        System.out.println("🧪 테스트 사용자 정보 확인 완료");
